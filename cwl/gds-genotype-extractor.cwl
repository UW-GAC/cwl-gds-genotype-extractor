...
doc: |-
  ...
  The first contains information about each variant included in the output, with the following columns:
  column | description
  --- | ---
  ...
  The second file contains a tibble with sample identifiers and genotypes for each variant:
  column | description
  --- | ---
